...
private extension ThemeColorPalette {
    var color: UIColor {
        switch self {
        case .white: return .color(fromHex: "#1C1C1E")
        case .gray: return .color(fromHex: "#A3A3A3")
        case .lightGray: return .color(fromHex: "#151515")
        case .black: return .color(fromHex: "#FFFFFF")
        case .primary: return .color(fromHex: "#2B74A2")
...
final class DarkTheme: ThemeProtocol {
    func kern(forStyle style: ThemeFontStyle) -> CGFloat { return 0 }
            ...
            AppearanceRuleSet {
                ...
                UITabBarItem[
                    ...
                    value: [
                        ...
                        NSAttributedString.Key.foregroundColor: self.color(forColorPalette: .gray)
                    ]
                ]
            }
    ...
    final func cleanThemeCopy() -> DarkTheme {
        return DarkTheme()
    }
}
